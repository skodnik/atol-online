 ...
 */
class Request implements ApiEntityInterface
{
    /**
     ...
     * @required true
     */
    private null|Receipt $receipt = null;
    ...
    public function setTimestamp(null|DateTimeImmutable $timestamp): Request
    {
    ...
    public function setExternalId(null|string $external_id): Request
    {
    ...
    public function setService(null|Service $service): Request
    {
    ...
    public function getReceipt(): null|Receipt
    {
        return $this->receipt;
    }

    public function setReceipt(null|Receipt $receipt): Request
    {
