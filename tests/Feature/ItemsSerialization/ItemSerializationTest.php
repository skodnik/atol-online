...
class ItemSerializationTest extends TestCase
{
    ...
    public function testVatSerialization()
    {
        ...
        self::assertEquals($object->measurementUnit, $item->getMeasurementUnit());
        self::assertEquals($object->paymentMethod, $item->getPaymentMethod()->value);
        self::assertEquals($object->paymentObject, $item->getPaymentObject()->value);
    }
}
